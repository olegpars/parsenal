...
GOAL="${DIGGER_OVERNIGHT_GOAL:-}"
WORK_DIR="${DIGGER_OVERNIGHT_WORKDIR:-$PWD}"
MAX_ITERATIONS="${DIGGER_OVERNIGHT_MAX_ITERATIONS:-40}"
SLEEP_ON_FAIL_MINUTES="${DIGGER_OVERNIGHT_SLEEP_ON_FAIL_MINUTES:-15}"
MAX_CONSECUTIVE_FAILS="${DIGGER_OVERNIGHT_MAX_CONSECUTIVE_FAILS:-5}"
AGENT_CMD="${DIGGER_OVERNIGHT_AGENT_CMD:-claude --print --permission-mode acceptEdits}"
